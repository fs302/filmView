...
<head>
    ...
    <title>What if it comes true?</title>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <p>Welcome, <s:property value="myName"/> ! </p>
            <p><a href="Bootstrap.action" class="btn btn-primary btn-lg" role="button">Learn more &raquo;</a></p>
        </div>
